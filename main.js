...
harderDiff.addEventListener('click', ()=>{ docBody.style.backgroundColor='black';
...
normalDiff.addEventListener('click', ()=>{ docBody.style.backgroundColor='rgb(204, 231, 198)';
